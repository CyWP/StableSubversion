...
def build_parser() -> argparse.ArgumentParser:
	p = argparse.ArgumentParser(prog="stable-subversion", description="StableSubversion CLI")
	...
	p.add_argument("--generate", "-g", type=Path, help="Path to pretrained model to generate from config")
